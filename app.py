...
Original file is located at
    https://colab.research.google.com/drive/1eZ_13GX9vcrVXS7ur-u7wl-3YhcJfzFO
"""
...
if "date" in X.columns: # لتقسيم عامود التاريخ الى اربعة اقسام ليسهل عملية التنبؤ
    ...
    # التحسين الثالث ، تم حذف عامود dayofweak  لعدم اهميته او تأثيره على النتيجة
...
!pip -q install gradio # لاستدعائها فيما بعد لانشاء واجهة مستخدم gradio تثبيت مكتبة
...
theme = gr.themes.Soft( # gradio استخدام ثيم جاهز من مكتبة
    ...
    secondary_hue="amber" ) # لون الخلفية
inputs = []
for col in X.columns:
        inputs.append(gr.Number(label=col, value=0 , interactive=True, minimum=0,maximum=10000)) # تحسين الثاني : ما يدخل قيم
...
app = gr.Interface( # إنشاء واجهة المستخدم
   ...
   theme=theme # لتطبيق الديزاين للواجهة
)
app.launch()